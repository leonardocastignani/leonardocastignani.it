...
faqs:
  - question: "What is web accessibility (A11y)?"
    answer: "Web accessibility involves designing websites that anyone can use, regardless of visual, auditory, motor, or cognitive abilities, including temporary disabilities."
  - question: "How does A11y improve my SEO in Italy and globally?"
    answer: "Accessible websites use semantic HTML that Google's bots easily crawl and index, rewarding your business with better rankings both locally in the Marche region and internationally."
  - question: "What are the core practices of an accessible site?"
    answer: "Key practices include proper color contrast ratios, full keyboard navigation, and semantic HTML tags for screen reader compatibility."
---
...
Technically speaking, the Google bot is the most important blind user that will ever visit your site.
Google doesn't "look" at images and doesn't use a mouse. It reads code.
