...
faqs:
  - question: "What is the main problem with React SPAs for simple websites?"
    answer: "React SPAs mandate heavy client-side rendering which forces mobile devices to download and parse large JS bundles just to display simple static content, severely hurting SEO."
  - question: "What are the main SEO benefits of migrating from React to Astro?"
    answer: "Astro provides highly semantic, instant-loading static HTML, which Google indexes flawlessly and rewards with top-tier Core Web Vitals rankings."
  - question: "Does migrating to Astro mean rewriting all my React code?"
    answer: "No. Astro natively supports React components via Islands Architecture, letting you reuse complex React logic only where dynamic interactivity is required."
---
