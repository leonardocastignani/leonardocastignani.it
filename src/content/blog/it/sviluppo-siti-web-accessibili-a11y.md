...
faqs:
  - question: "Cos'è l'accessibilità web (A11y)?"
    answer: "L'accessibilità web consiste nel progettare siti utilizzabili da chiunque, incluse persone con disabilità visive, uditive, motorie o cognitive, e disabilità temporanee."
  - question: "Perché l'accessibilità web migliora la SEO locale?"
    answer: "Google premia i siti con codice HTML semantico e facili da scansionare. Un sito accessibile si posiziona meglio nei risultati di ricerca, aiutando le aziende di Civitanova Marche a emergere sul territorio."
  - question: "Quali sono le basi per un sito web accessibile?"
    answer: "Le basi includono un alto contrasto cromatico, la navigazione tramite tastiera e l'uso corretto dei tag HTML semantici per supportare gli screen reader."
---
...
Gli utenti non vedenti utilizzano software chiamati *Screen Reader* che "leggono" il sito ad alta voce. Se il tuo sviluppatore ha costruito bottoni usando semplici `<div>` invece del tag corretto `<button>`, lo screen reader non capirà che è un elemento cliccabile. 
Usare tag semantici (come `<nav>`, `<main>`, `<article>`) e attributi ARIA assicura che il sito abbia senso anche quando viene solo "ascoltato".
...
Il bot di Google, tecnicamente, è l'utente non vedente più importante che visiterà mai il tuo sito. 
Google non "guarda" le immagini e non usa il mouse. Legge il codice. 
