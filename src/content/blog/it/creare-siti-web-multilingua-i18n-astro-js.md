...
faqs:
  - question: "Cos'è l'i18n nello sviluppo web?"
    answer: "L'i18n (internazionalizzazione) è il processo tecnico che permette a un sito web di supportare molteplici lingue senza duplicare la logica del codice di base."
  - question: "Perché usare il routing a sottocartelle per la SEO multilingua?"
    answer: "Google preferisce la struttura a sottocartelle (es. /it/ e /en/) perché garantisce URL chiari, rendendo l'indicizzazione geolocalizzata più efficace per le PMI delle Marche che esportano all'estero."
  - question: "Quali sono i vantaggi di Astro per siti bilingue?"
    answer: "Astro gestisce il multilingua nativamente a build time, restituendo codice HTML puro senza caricare pesanti librerie JavaScript, assicurando velocità e performance estreme."
---
