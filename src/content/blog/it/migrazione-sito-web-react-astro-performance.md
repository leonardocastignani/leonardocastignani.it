...
faqs:
  - question: "Perché dovrei migrare un sito da React ad Astro?"
    answer: "Le SPA in React puro soffrono spesso di problemi di SEO e bundle JS enormi. Migrare ad Astro trasforma il sito in una MPA, raggiungendo score 100/100 su Lighthouse."
  - question: "Posso mantenere i miei componenti React se passo ad Astro?"
    answer: "Sì! Grazie all'Architettura a Isole, puoi importare e utilizzare i tuoi vecchi componenti React all'interno di Astro, idratandoli solo dove strettamente necessario."
  - question: "Quando conviene mantenere React invece di usare Astro?"
    answer: "React (o Next.js) è insostituibile per Web App complesse con stati globali frequenti (es. dashboard in tempo reale o tool SaaS), dove la navigazione non deve ricaricare la pagina."
---
